# ANNOTATION GUIDELINE — Bounding Box, Polygon & Polyline
...
> **Lưu ý:** Tài liệu này chuẩn hóa rule set G01 cho bài thực hành. Nếu guideline chính thức của batch/customer có quy định khác, **guideline của batch/customer được ưu tiên**.
...
> **⚠️ Quan trọng:** Không dùng Polygon và Polyline thay thế lẫn nhau trong cùng bài. Drivable area dùng Polygon; lane marking dùng Polyline. Điều này giúp annotation nhất quán và có thể chấm/evaluate được.
